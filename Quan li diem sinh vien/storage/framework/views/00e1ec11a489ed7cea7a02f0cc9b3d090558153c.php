...
<?php $__env->startSection('content'); ?>
	<div class="card">
		...
		<div class="card-body">
			<p><a href="<?php echo e(url('/diem/them')); ?>" class="btn btn-primary"><i class="fal fa-plus"></i> Thêm mới</a>
				...
				<tbody>
					<?php $__currentLoopData = $diem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td class="text-center"><a href="<?php echo e(url('/diem/xoa/' . $value->MaSV_id.'/'.$value->maMH_id)); ?>"><i class="fal fa-trash-alt text-danger"></i></a></td>
						</tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\Quan_Diem_SV - Loading\resources\views/diem/danhsach.blade.php ENDPATH**/ ?>