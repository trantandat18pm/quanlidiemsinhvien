...
unset($__errorArgs, $__bag); ?>" id="lop_id" name="lop_id">
						...
						<?php $__currentLoopData = $lop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($sinhvien->lop_id == $value->malop): ?>
								<option value="<?php echo e($value->malop); ?>" selected><?php echo e($value->tenlop); ?></option>
							<?php else: ?>
...
unset($__errorArgs, $__bag); ?>" id="masv" name="masv" value="<?php echo e($sinhvien->masv); ?>" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\TestTheme\Quan_Diem_SV - Loading\resources\views/sinhvien/sua.blade.php ENDPATH**/ ?>