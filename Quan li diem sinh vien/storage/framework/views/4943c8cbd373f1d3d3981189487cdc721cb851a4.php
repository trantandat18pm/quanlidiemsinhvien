					  ...
					  <div class="col-sm-6">
					    <div class="card" id="card1">
					      <div class="card-body">
					        ...
					        <h5 class="card-title">QUẢN LÍ GIẢNG VIÊN</h5>
					        <p class="card-text">Quản lí thông tin của từng giảng viên.</p>
					        <a href="<?php echo e(url('/giangvien')); ?>" class="btn btn-primary">
							 Đi nào!-->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\Quan_Diem_SV - Loading\resources\views/home.blade.php ENDPATH**/ ?>