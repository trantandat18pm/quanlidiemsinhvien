...
<?php $__env->startSection('content'); ?>
	<div class="card">
		...
		<div class="card-body">
			<form action="<?php echo e(url('/lop/them')); ?>" method="post">
				<?php echo csrf_field(); ?>
				<div class="form-group">
					<label for="malop">Mã lớp</label>
					<input type="text" class="form-control <?php $__errorArgs = ['malop'];
...
unset($__errorArgs, $__bag); ?>" id="tenlop" name="tenlop" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\TestTheme\Quan_Diem_SV - Loading\resources\views/lop/them.blade.php ENDPATH**/ ?>