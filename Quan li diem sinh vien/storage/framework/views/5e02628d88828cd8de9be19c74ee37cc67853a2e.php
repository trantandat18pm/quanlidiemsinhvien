...
<?php $__env->startSection('content'); ?>
	<div class="card">
		...
		<div class="card-body">
			...
			<form action="<?php echo e(url('/giangvien/sua/' . $giangvien->id)); ?>" method="post">
				<?php echo csrf_field(); ?>
			
				
				<div class="form-group">
					<label for="tengv">Tên lớp</label>
					<input type="text" class="form-control <?php $__errorArgs = ['tengv'];
...
unset($__errorArgs, $__bag); ?>" id="tengv" name="tengv" value="<?php echo e($giangvien->tengv); ?>" />
...
unset($__errorArgs, $__bag); ?>" id="khoa_id" name="khoa_id">
						...
						<?php $__currentLoopData = $khoa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($giangvien->khoa_id == $value->makhoa): ?>
								<option value="<?php echo e($value->makhoa); ?>" selected><?php echo e($value->tenkhoa); ?></option>
							<?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp\www\TestTheme\Quan_Diem_SV - Loading\resources\views/giangvien/sua.blade.php ENDPATH**/ ?>