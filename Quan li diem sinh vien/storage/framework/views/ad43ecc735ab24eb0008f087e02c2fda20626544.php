...
<body>
  ...
  <nav class="navbar navbar-light bg-light static-top">
    <div class="container">
      ...
      <a class="btn btn-primary" href="<?php echo e(route('login')); ?>">Đăng Nhập</a>
      <?php else: ?>
            <a class="btn btn-success" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Đăng xuất</a>
...
<!--                 <button type="submit" class="btn btn-block btn-lg btn-primary">Đăng Nhập</button>
 -->            
              <a class="btn btn-block btn-lg btn-info" href="<?php echo e(url('/trangchu')); ?>">Giao diện chức năng</a>
              </div>
                            <?php endif; ?>  
